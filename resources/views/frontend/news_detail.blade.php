            ...
            <div class="row">
                ...
                <div class="col-lg-12 entries">
                    ...
                    <article class="entry entry-single">
                        ...
                        <div class="entry-img">
                            <img src="{{asset($news->image)}}" alt="Story Image" class="img-fluid">
                        </div>
                        ...
                        <div class="entry-meta">
                            <ul>
                                ...
                                <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="#">{{$news->created_at}}<time datetime="2020-01-01"></time></a></li>
                            </ul>
                        </div>
