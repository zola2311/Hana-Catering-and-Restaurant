                        ...
                        <div class="card">
                            <div class="container mt-4">
                                @if (auth()->user()->unreadNotifications->count() > 0)
                                    ...
                                    <a href="{{route('mark-as-deliver')}}" class="btn btn-secondary float-right">Clear Notification</a>
                                @endif
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <nav class="w-100">
                                    <div class="nav nav-tabs" id="product-tab" role="tablist">
                                        <a class="nav-item nav-link" id="product-desc-tab" data-toggle="tab" href="#product-desc" role="tab" aria-controls="product-desc" aria-selected="true">Booking Notifications</a>
                                        <a class="nav-item nav-link active" id="product-comments-tab" data-toggle="tab" href="#product-comments" role="tab" aria-controls="product-comments" aria-selected="false">Delivery Notifications</a>
                                    </div>
                                </nav>
